...
execute as @a at @s if entity @s[hasitem={item=syakai:add}] unless entity @s[hasitem={item=syakai:add,location=slot.inventory,slot=2}] if entity @s[scores={menu=..1}] run scoreboard players add @s menu 1
...
execute as @a at @s if entity @s[hasitem={item=syakai:remove}] unless entity @s[hasitem={item=syakai:remove,location=slot.inventory,slot=0}] if entity @s[scores={menu=2..}] run scoreboard players remove @s menu 1
...
execute as @a[scores={menu=2}] at @s if entity @s[hasitem={item=syakai:wp_menu}] unless entity @s[hasitem={item=syakai:wp_menu,location=slot.inventory,slot=1}] if entity @a[rm=0.01,c=1] run scoreboard players remove @s money 20
execute as @a[scores={menu=2}] at @s if entity @s[hasitem={item=syakai:wp_menu}] unless entity @s[hasitem={item=syakai:wp_menu,location=slot.inventory,slot=1}] if entity @a[rm=0.01,c=1] as @a[rm=0.01,c=1] run tellraw @s {"rawtext":[{"selector":"@p"},{"text":"§eから20WPが送金されました§r"}]}
execute as @a[scores={menu=2}] at @s if entity @s[hasitem={item=syakai:wp_menu}] unless entity @s[hasitem={item=syakai:wp_menu,location=slot.inventory,slot=1}] if entity @a[rm=0.01,c=1] run tellraw @s {"rawtext":[{"selector":"@a[rm=0.01,c=1]"},{"text":"§eに20WPを送金しました§r"}]}
execute as @a[scores={menu=2}] at @s if entity @s[hasitem={item=syakai:wp_menu}] unless entity @s[hasitem={item=syakai:wp_menu,location=slot.inventory,slot=1}] run clear @s syakai:wp_menu
execute as @a[scores={menu=2}] at @s if entity @s[hasitem={item=syakai:hk_wp}] unless entity @s[hasitem={item=syakai:hk_wp,location=slot.inventory,slot=1}] run clear @s syakai:hk_wp